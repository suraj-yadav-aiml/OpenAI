...
def main():
    parser = argparse.ArgumentParser(description="Simple command line ChatBot with GPT-3")
    ...
    while True:
        ...
        try:
            user_input = input(blue(bold("YOU: ")))
            ...
            print(f"{red(bold('Assistant'))}: {response.choices[0].message.content}")
